          ...
          <div className="flex flex-col gap-5 lg:flex-row">
            ...
            <div className="flex flex-col gap-2 lg:w-[48%]">
              ...
              <input
                ...
                id="lastName"
                placeholder="Enter first name"
                className="form-style w-full px-5 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
